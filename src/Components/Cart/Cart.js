    ...
    function placeOrder() {
        products.map((e) => {
            ...
            axios.post('http://localhost:3001/orders', {
                product_name: e.name, price: e.price, quantity: e.amount, image: e.img,
                size: e.size, color: e.color, order_date: currentDate, email: localStorage.getItem('email'), type: e.type
            }).then((res) => {
